...
type TabId = 'upcoming' | 'rocket-rush' | 'nil' | 'past' | 'standings';

export default function EventsClient({ initialTournaments }: EventsClientProps) {
    ...
    const isLiveActive = tournaments.some(t => t.state === 'ACTIVE' || t.state === 'IN_PROGRESS');
        ...
        <div className="text-white min-h-screen">
                ...
                <div className="max-w-[1600px] mx-auto px-6 md:px-10 py-4">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div className="flex bg-[#111]/80 backdrop-blur-md p-1 rounded-xl border border-white/5 shrink-0 shadow-lg">
                            <Link
                                href="/esports"
                                className="px-6 py-2 rounded-lg font-bold text-gray-400 hover:text-white hover:bg-white/5 transition-all"
                            >
                                Overview
                            </Link>
                            <Link
                                href="/esports/events"
                                className="flex items-center gap-2 px-6 py-2 rounded-lg font-bold bg-pink-600 text-white shadow-lg shadow-pink-600/20 transition-all font-[family-name:var(--font-heading)]"
                            >
                                Events
                            </Link>
                            <Link
                                href="/esports"
                                className="px-6 py-2 rounded-lg font-bold text-gray-400 hover:text-white hover:bg-white/5 transition-all w-full text-center md:w-auto"
                                onClick={() => {
                                    // We need to handle this manually since we are linking to a specific state in another component
                                    // Ideally this link should pass a query param ?view=analytics
                                    // For now, we link to root. The user handles the view state in EsportsHQClient.
                                }}
                            >
                                Analytics
                            </Link>
                            <Link
                                href="/esports"
                                className={`flex items-center gap-2 px-6 py-2 rounded-lg font-bold transition-all ${isLiveActive
                                    ? 'text-red-500 bg-red-500/10 border border-red-500/20 animate-pulse'
                                    : 'text-gray-400 hover:text-white hover:bg-white/5'
                                    }`}
                            >
                                <span className={`w-2 h-2 rounded-full ${isLiveActive ? 'bg-red-500 animate-pulse' : 'bg-gray-400'}`}></span> Live
                            </Link>
                        </div>
                    </div>
                </div>
            ...
            <div className="p-6 md:p-10 max-w-[1600px] mx-auto space-y-8 pt-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4 md:gap-6">
                    <div className="bg-[#111] border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
                        <div className="w-12 h-12 rounded-xl bg-cyan-500/10 flex items-center justify-center mb-4 border border-cyan-500/20">
                            <FaTrophy className="text-2xl text-cyan-500" />
                        </div>
                        <div>
                            <div className="text-gray-400 text-[10px] font-bold uppercase tracking-widest mb-1">Past Events</div>
                    ...
                    <div className="bg-[#111] border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
                        ...
                        <div>
                            <div className="text-gray-400 text-[10px] font-bold uppercase tracking-widest mb-1">Players</div>
                            <div className="text-3xl font-black text-white">
                    ...
                    <div className="bg-[#111] border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
                        ...
                        <div>
                            <div className="text-gray-400 text-[10px] font-bold uppercase tracking-widest mb-1">Teams</div>
                            <div className="text-3xl font-black text-white">
                    ...
                    <div className="bg-[#111] border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
                        ...
                        <div>
                            <div className="text-gray-400 text-[10px] font-bold uppercase tracking-widest mb-1">Total Prize Pool</div>
                            <div className="text-3xl font-black text-white">
